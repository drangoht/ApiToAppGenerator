...
`;
            ...
            // Full shadcn/ui-compatible tailwind config with CSS variable color tokens.
            // The LLM frequently generates @apply border-border, bg-background, text-foreground etc.
            // which all reference CSS variables. Without these theme extensions they cause CssSyntaxError.
